...
export function checkEndOfRound(state) {
    ...
    if (bothPassed) {
        return Object.assign(Object.assign({}, state), { phase: 'roundEnd' });
    }
    return state;
}
...
export function passTurn(state, player) {
    ...
    return Object.assign(Object.assign({}, state), { players: Object.assign(Object.assign({}, state.players), { [player]: Object.assign(Object.assign({}, playerState), { passed: true }) }), turn: Object.assign(Object.assign({}, state.turn), { hasPlayedCard: true }) });
}
export function gameLoop(config, initialState) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (state.phase !== 'gameOver') {
            ...
            if (state.phase === 'play') {
                ...
                const newState = yield controller.makeMove(state, state.currentPlayer);
